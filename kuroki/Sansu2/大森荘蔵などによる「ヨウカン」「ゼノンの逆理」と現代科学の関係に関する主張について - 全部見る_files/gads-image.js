	...
	if (google_ads.length > start) {
		...
		for (var i=start; i<end; i++) {
			...
			str += '<li style="list-style-type:none; display:block;">'
			    +    '<div style="padding:4px 8px; text-align:center; line-height:130%; font-family:\'ＭＳ Ｐゴシック\',Osaka,\'ヒラギノ角ゴ Pro W3\';">'
		...
		str += '</ul>';
		str += '<div style="height:15px; text-align:center; margin:0 8px 1em 0; font-weight:normal; font-size:12px; font-family:"ＭＳ Ｐゴシック",Osaka,"ヒラギノ角ゴ Pro W3";"><a href="' + google_info.feedback_url + '" target="_blank">Ads by Google</a></div>';
		str += '</div>';
	}
	return str;
}
