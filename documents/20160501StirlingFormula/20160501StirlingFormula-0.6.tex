...
{http://www.math.tohoku.ac.jp/{\textasciitilde}kuroki/LaTeX/20160501StirlingFormula.pdf}
}}
...
\subsection{対数版の易しいStirlingの公式の微小な改良}
...
上の公式の違いは $(1/2)\log n$ の項と定数項 $c$ である.
それらの項を出すアイデアは次の通り.
...
この方針であれば $u(t,x)$ が熱方程式の基本解であることを使わなくてよい.
