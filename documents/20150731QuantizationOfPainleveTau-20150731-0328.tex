...
\def\DATE{2015年7月31日(金) 03.28 Version 0.3}
\def\ABSTRACT{}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
多くの議論が対称化可能一般Cartan行列に付随する極めて一般的な場合に拡張可能なのだが, 
表現論の言葉に不慣れだが, Painlev\'e系に関する知識はある読者のために, 
$q$ 差分版のPainlev\'e IV 型方程式の対称形式 \qP{IV} を例に説明して行く.

目標は量子化された Painlev\'e 系を表現論の言葉で統一的に定式化し, 
...
作用を以下のように定めることができる%
%\footnote{以下の式は実は非可換の場合でも通用するように積の順序を注意深く決めてある.}%
:
\begin{align*}
 &
 s_i(x_i) 
