...
7月28日(Ver.0.04, 21頁): \secref{sec:nextK=P+intK}を追加した.
7月28日(Ver.0.05, 23頁): \secref{sec:formal-Simpson}を追加した.
}}
\def\ABSTRACT{%
...
\[
  ...
  \right|
  \leqq
  2h\sum_{k=0}^{N-1}\frac{h^4}{180}M
  = \frac{M(b-a)}{180}h^4
\]
のように上から抑えられる.
Simpsonの公式による定積分の数値計算の誤差は,
$h$ が小さいとき, 大体 $M(b-a)h^4/180$ 以下になると考えられる.
